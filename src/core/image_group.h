...
enum {
    ...
    GROUP_FIGURE_FORT_JAVELIN = 202,
    GROUP_FIGURE_FORT_LEGIONARY = 204,
    ...
    GROUP_PRIEST_OSIRIS = 197 + SPR_MAIN_OFFSET + PHARAOH_OFFSET, // sprmain
    GROUP_PRIEST_RA = 210 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_PRIEST_SETH = 193 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_PRIEST_PTAH = 187 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_PRIEST_BAST = 208 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_MARKET_LADY_2 = 18 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_POLICEMAN = 20 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_MAGISTRATE = 212 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_REED_GATHERER = 37 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_HUNTER = 45 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_HUNTER_ARROW = 0 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_TRADE_CARAVAN_DONKEY = 52 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_WATER_CARRIER = 59 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_WORKER_PH = 116 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
    GROUP_FIGURE_MORTUARY = 195 + SPR_MAIN_OFFSET + PHARAOH_OFFSET,
