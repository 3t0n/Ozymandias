...
int city_trade_next_caravan_import_resource(void) {
    ...
    if (city_data.trade.caravan_import_resource >= RESOURCE_MAX[get_game_engine()])
...
int city_trade_next_caravan_backup_import_resource(void) {
    ...
    if (city_data.trade.caravan_backup_import_resource >= RESOURCE_MAX[get_game_engine()])
...
int city_trade_next_docker_import_resource(void) {
    ...
    if (city_data.trade.docker_import_resource >= RESOURCE_MAX[get_game_engine()])
...
int city_trade_next_docker_export_resource(void) {
    ...
    if (city_data.trade.docker_export_resource >= RESOURCE_MAX[get_game_engine()])
